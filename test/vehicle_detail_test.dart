...
void main() {
  testWidgets(
    'VehicleDetailView renders specifications, policies, reviews, and interactive booking configurator',
    (WidgetTester tester) async {
      ...
      expect(
        find.text('5'),
        findsWidgets,
      ); // 5 seats spec & reviews rating references
      ...
      expect(
        find.text('Select pickup & return dates to see price breakdown.'),
        findsOneWidget,
      );
      ...
      expect(
        find.text('₦100,000'),
        findsWidgets,
      ); // Security deposit alert + breakdown row
